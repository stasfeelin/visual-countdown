...
const PRESET_COLORS = [
  { name: 'Purple', value: 'oklch(0.55 0.2 285)' },
  { name: 'Blue', value: 'oklch(0.55 0.18 250)' },
  { name: 'Cyan', value: 'oklch(0.65 0.15 195)' },
  { name: 'Teal', value: 'oklch(0.6 0.15 180)' },
  { name: 'Green', value: 'oklch(0.6 0.18 145)' },
  { name: 'Lime', value: 'oklch(0.7 0.18 125)' },
  { name: 'Yellow', value: 'oklch(0.75 0.15 95)' },
  { name: 'Orange', value: 'oklch(0.65 0.18 55)' },
  { name: 'Pink', value: 'oklch(0.65 0.2 350)' },
  { name: 'Rose', value: 'oklch(0.6 0.2 15)' },
  { name: 'Indigo', value: 'oklch(0.45 0.18 275)' },
          ...
          {PRESET_COLORS.map((color) => (
            <button
              ...
              style={{
                ...
                borderColor: selectedColor === color.value ? 'oklch(0.75 0.15 195)' : 'transparent',
              }}
